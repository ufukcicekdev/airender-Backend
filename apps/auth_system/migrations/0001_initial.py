    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="verification_tokens", to="auth_system.user")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("expires_at", models.DateTimeField()),
                ("used", models.BooleanField(default=False)),
                ("user", models.ForeignKey(on_delete=models.deletion.CASCADE, related_name="password_reset_tokens", to="auth_system.user")),
            ],
